...
var file_proto_file_proto_rawDesc = []byte{
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0x90, 0x02, 0x0a, 0x04, 0x46, 0x69, 0x6c, 0x65, 0x12,
...
var file_proto_file_proto_depIdxs = []int32{
	...
	1,  // 9: file.File.BatchSave:input_type -> file.BatchSaveRequest
	4,  // 10: file.File.Read:output_type -> file.ReadResponse
	8,  // 11: file.File.List:output_type -> file.ListResponse
	6,  // 12: file.File.Save:output_type -> file.SaveResponse
	10, // 13: file.File.Delete:output_type -> file.DeleteResponse
	2,  // 14: file.File.BatchSave:output_type -> file.BatchSaveResponse
