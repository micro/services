...
type Contract struct {
	...
	// seller fees
	SellerFees float64 `protobuf:"fixed64,10,opt,name=seller_fees,json=sellerFees,proto3" json:"seller_fees,omitempty"`
}
...
func (x *Contract) GetSellerFees() float64 {
	if x != nil {
		return x.SellerFees
	}
	return 0
...
type Collection struct {
	...
	SellerFees float64 `protobuf:"fixed64,9,opt,name=seller_fees,json=sellerFees,proto3" json:"seller_fees,omitempty"`
...
func (x *Collection) GetSellerFees() float64 {
	if x != nil {
		return x.SellerFees
	}
	return 0
...
type Transaction struct {
	...
	TransactionIndex float64 `protobuf:"fixed64,8,opt,name=transaction_index,json=transactionIndex,proto3" json:"transaction_index,omitempty"`
}
...
var file_proto_nft_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x01, 0x52, 0x0a, 0x73, 0x65, 0x6c, 0x6c, 0x65, 0x72, 0x46, 0x65, 0x65, 0x73, 0x22,
	...
	0x6c, 0x6c, 0x65, 0x72, 0x5f, 0x66, 0x65, 0x65, 0x73, 0x18, 0x09, 0x20, 0x01, 0x28, 0x01, 0x52,
	...
	0x01, 0x28, 0x01, 0x52, 0x10, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e,
