...
var file_proto_evchargers_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x06, 0x6c, 0x61, 0x74, 0x4c, 0x6e, 0x67, 0x22, 0xf5, 0x02, 0x0a, 0x0a, 0x43,
	...
	0x65, 0x6c, 0x12, 0x2e, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x0b, 0x20, 0x01,
	...
	0x75, 0x73, 0x22, 0x16, 0x0a, 0x14, 0x52, 0x65, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x44,
...
var file_proto_evchargers_proto_depIdxs = []int32{
	...
	16, // 13: evchargers.Connection.status:type_name -> evchargers.StatusType
	9,  // 14: evchargers.ReferenceDataResponse.charger_types:type_name -> evchargers.ChargerType
	10, // 15: evchargers.ReferenceDataResponse.connection_types:type_name -> evchargers.ConnectionType
	11, // 16: evchargers.ReferenceDataResponse.current_types:type_name -> evchargers.CurrentType
	12, // 17: evchargers.ReferenceDataResponse.countries:type_name -> evchargers.Country
	13, // 18: evchargers.ReferenceDataResponse.data_providers:type_name -> evchargers.DataProvider
	15, // 19: evchargers.ReferenceDataResponse.operators:type_name -> evchargers.Operator
	16, // 20: evchargers.ReferenceDataResponse.status_types:type_name -> evchargers.StatusType
	17, // 21: evchargers.ReferenceDataResponse.submission_status_types:type_name -> evchargers.SubmissionStatusType
	18, // 22: evchargers.ReferenceDataResponse.usage_types:type_name -> evchargers.UsageType
	19, // 23: evchargers.ReferenceDataResponse.user_comment_types:type_name -> evchargers.UserCommentType
	20, // 24: evchargers.ReferenceDataResponse.checkin_status_types:type_name -> evchargers.CheckinStatusType
	14, // 25: evchargers.DataProvider.data_provider_status_type:type_name -> evchargers.DataProviderStatusType
	0,  // 26: evchargers.Evchargers.Search:input_type -> evchargers.SearchRequest
	7,  // 27: evchargers.Evchargers.ReferenceData:input_type -> evchargers.ReferenceDataRequest
	3,  // 28: evchargers.Evchargers.Search:output_type -> evchargers.SearchResponse
	8,  // 29: evchargers.Evchargers.ReferenceData:output_type -> evchargers.ReferenceDataResponse
