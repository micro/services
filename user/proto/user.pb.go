...
var file_proto_user_proto_depIdxs = []int32{
	...
	22, // 17: user.User.SendPasswordResetEmail:input_type -> user.SendPasswordResetEmailRequest
	24, // 18: user.User.ResetPassword:input_type -> user.ResetPasswordRequest
	...
	23, // 29: user.User.SendPasswordResetEmail:output_type -> user.SendPasswordResetEmailResponse
	25, // 30: user.User.ResetPassword:output_type -> user.ResetPasswordResponse
