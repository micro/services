...
var file_proto_user_proto_rawDesc = []byte{
	...
	0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0x51, 0x0a, 0x0d, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65,
	...
	0x28, 0x09, 0x52, 0x05, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x22, 0x10, 0x0a, 0x0e, 0x55, 0x70, 0x64,
	0x61, 0x74, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x9e, 0x01, 0x0a, 0x15,
	...
	0x66, 0x69, 0x72, 0x6d, 0x50, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x22, 0x18, 0x0a, 0x16,
	0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x50, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x52, 0x65,
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x6f, 0x0a, 0x0d, 0x53, 0x65, 0x61, 0x72, 0x63, 0x68,
	...
	0x06, 0x6f, 0x66, 0x66, 0x73, 0x65, 0x74, 0x22, 0x3b, 0x0a, 0x0e, 0x53, 0x65, 0x61, 0x72, 0x63,
	0x68, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x29, 0x0a, 0x08, 0x61, 0x63, 0x63,
	0x6f, 0x75, 0x6e, 0x74, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0d, 0x2e, 0x75, 0x73,
	0x65, 0x72, 0x2e, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x52, 0x08, 0x61, 0x63, 0x63, 0x6f,
	0x75, 0x6e, 0x74, 0x73, 0x22, 0x32, 0x0a, 0x12, 0x52, 0x65, 0x61, 0x64, 0x53, 0x65, 0x73, 0x73,
	...
	0x65, 0x32, 0x93, 0x04, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12, 0x35, 0x0a, 0x06, 0x43, 0x72,
	...
	0x00, 0x12, 0x2f, 0x0a, 0x04, 0x52, 0x65, 0x61, 0x64, 0x12, 0x11, 0x2e, 0x75, 0x73, 0x65, 0x72,
	0x2e, 0x52, 0x65, 0x61, 0x64, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x12, 0x2e, 0x75,
	0x73, 0x65, 0x72, 0x2e, 0x52, 0x65, 0x61, 0x64, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	...
	0x12, 0x35, 0x0a, 0x06, 0x53, 0x65, 0x61, 0x72, 0x63, 0x68, 0x12, 0x13, 0x2e, 0x75, 0x73, 0x65,
...
var file_proto_user_proto_goTypes = []interface{}{
	...
	(*SearchResponse)(nil),         // 13: user.SearchResponse
	(*ReadSessionRequest)(nil),     // 14: user.ReadSessionRequest
	(*ReadSessionResponse)(nil),    // 15: user.ReadSessionResponse
...
var file_proto_user_proto_depIdxs = []int32{
	...
	0,  // 1: user.SearchResponse.accounts:type_name -> user.Account
	1,  // 2: user.ReadSessionResponse.session:type_name -> user.Session
	1,  // 3: user.LoginResponse.session:type_name -> user.Session
	2,  // 4: user.User.Create:input_type -> user.CreateRequest
	6,  // 5: user.User.Read:input_type -> user.ReadRequest
	8,  // 6: user.User.Update:input_type -> user.UpdateRequest
	4,  // 7: user.User.Delete:input_type -> user.DeleteRequest
	12, // 8: user.User.Search:input_type -> user.SearchRequest
	10, // 9: user.User.UpdatePassword:input_type -> user.UpdatePasswordRequest
	16, // 10: user.User.Login:input_type -> user.LoginRequest
	18, // 11: user.User.Logout:input_type -> user.LogoutRequest
	14, // 12: user.User.ReadSession:input_type -> user.ReadSessionRequest
	3,  // 13: user.User.Create:output_type -> user.CreateResponse
	7,  // 14: user.User.Read:output_type -> user.ReadResponse
	9,  // 15: user.User.Update:output_type -> user.UpdateResponse
	5,  // 16: user.User.Delete:output_type -> user.DeleteResponse
	13, // 17: user.User.Search:output_type -> user.SearchResponse
	11, // 18: user.User.UpdatePassword:output_type -> user.UpdatePasswordResponse
	17, // 19: user.User.Login:output_type -> user.LoginResponse
	19, // 20: user.User.Logout:output_type -> user.LogoutResponse
	15, // 21: user.User.ReadSession:output_type -> user.ReadSessionResponse
