...
func (e *Function) Deploy(ctx context.Context, req *function.DeployRequest, rsp *function.DeployResponse) error {
	...
	cmd := exec.Command("gcloud", "functions", "deploy", multitenantPrefix+"-"+req.Name, "--zone", "europe-west2-a", "--allow-unauthenticated", "--entry-point", req.Entrypoint, "--trigger-http", "--project", e.project, "--runtime", "nodejs14")
